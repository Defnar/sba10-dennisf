...
export default function NavBarDropDown({
  ...
  const buttonStyles = "hover:cursor-pointer hover:bg-blue-200 dark:hover:bg-blue-800 w-full text-center"
  return (
    <div
      ref={ref}
      className="absolute top-full -left-10 mt-1 bg-white dark:bg-gray-900 border rounded shadow-lg w-25 flex flex-col"
    >
